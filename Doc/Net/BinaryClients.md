# Clients BinaryWrapper par lots
...
Aucun lot suivant ne démarre. Après la sortie des deux workers, les nettoyages des
deux clients sont tentés, même si le premier échoue. Une erreur de nettoyage
fait échouer le lot.
