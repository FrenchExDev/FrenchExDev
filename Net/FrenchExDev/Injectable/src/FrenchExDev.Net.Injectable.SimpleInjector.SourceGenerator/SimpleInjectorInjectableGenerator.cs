...
namespace FrenchExDev.Net.Injectable.SimpleInjector.SourceGenerator;

[Generator]
public sealed class SimpleInjectorInjectableGenerator : IIncrementalGenerator
{
        ...
        Compilation compilation)
    {
        ...
        var source = InjectableEmitter.EmitSimpleInjector(emitModel);
