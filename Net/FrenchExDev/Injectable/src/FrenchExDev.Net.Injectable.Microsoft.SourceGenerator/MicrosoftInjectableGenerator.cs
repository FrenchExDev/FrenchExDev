...
namespace FrenchExDev.Net.Injectable.Microsoft.SourceGenerator;

[Generator]
public sealed class MicrosoftInjectableGenerator : IIncrementalGenerator
{
        ...
        Compilation compilation)
    {
        ...
        var source = InjectableEmitter.EmitMicrosoft(emitModel);
