...
{
    Console.WriteLine("""
        Collect podman-compose help using shared dependencies and per-version images (alpine:3.19).
          --min-version <version>       Minimum version (default: 1.0.0).
...
{
    ImageName = "podman-compose",
    BaseImage = "alpine:3.19",
    Platform = "linux/amd64",
    BaseInstallScript = "apk add --no-cache python3 py3-pip py3-yaml py3-dotenv",
    InstallScript = v =>
